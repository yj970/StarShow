 ...
 */
public class MyTimePickerView extends MyBasePickerView implements View.OnClickListener {
    ...
    public void returnData() {
        if (mPickerOptions.timeSelectListener != null) {
            try {
                Date date = WheelTime.dateFormat.parse(wheelTime.getTime());
                mPickerOptions.timeSelectListener.onTimeSelect(date, clickView, wheelTime.getWeek());
            } catch (ParseException e) {
                e.printStackTrace();
            }
        }
